...
function BankAdjust() {
  ...
  const [type, setType] = useState("Increase Balance");
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${config.base_url}/save_bank_adjust/`, dt)
      .then((res) => {
        ...
        <div className="card radius-15 h-20">
          <div className="row">
            <div className="col-md-12">
              <center>
                <h2 className="mt-3">BANK TO CASH PAYMENT</h2>
              </center>
              <hr />
            </div>
          </div>
