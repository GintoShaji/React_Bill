...
urlpatterns = [
    ...
    #Bill
    path('fetch_purchasebill/<int:id>/',Fin_fetchPurchaseBill),
    path('fetch_purchasebill_data/<int:id>/',Fin_fetchPurchaseBillData),
    path('get_billvendor_data/',Fin_get_billVendorData),
